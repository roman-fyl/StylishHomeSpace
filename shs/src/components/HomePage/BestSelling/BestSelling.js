    ...
    <div className="bestselling_main">
      ...
      <ul className="bestselling_items">
        <li className="bestselling_item" data-id="#">
          <span className="item_image"><a href="#" > <img src={bestseller1} className="item_image" alt="Bestselling product 1"/></a>
          </span>
        ...
        <li className="bestselling_item" data-id="#">
          <span className="item_image"><a href="#" > <img src={bestseller2} className="item_image" alt="Bestselling product 1"/></a>
          </span>
          <div className="item_description">
            <span className="item_brand-logos">
             <a href="#" className="item_brand-logo">
        ...
        <li className="bestselling_item" data-id="#">
          <span className="item_image"><a href="#" > <img src={bestseller3} className="item_image" alt="Bestselling product 1"/></a>
          </span>
          <div className="item_description">
            <span className="item_brand-logos">
             <a href="#" className="item_brand-logo">
