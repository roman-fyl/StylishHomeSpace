...
return (
    ...
    <img src={logo} alt="HomePage Logo" className="logo_homepage"/>
     ...
     <form>
         ...
         <Link to="/order-tracking"><div className="header_block"><img src={iconOrderStatus}></img><span className="header_call"><span>Order Tracking</span></span></div></Link>
         <Link to="/sign-in"><div className="header_block"><img src={iconLogIn}></img><span className="header_account"><span>Hello, <span>Roman</span></span><span>SIGN IN</span></span></div></Link>
