...
return (
    ...
    <div className="container_header">
     ...
     <a href="#"><img src={logo} alt="HomePage Logo" className="logo_homepage"/></a>
     <form>
         ...
         <a href="#"><div className="header_block"><img src={iconOrderStatus}></img><span className="header_call"><span>Order Status</span></span></div></a>
         <a href="#"><div className="header_block"><img src={iconLogIn}></img><span className="header_account"><span>Hello, <span>Roman</span></span><span>SIGN IN</span></span></div></a>
