        ...
        <div className="privacy_description">
          ...
          <section className="section">
            <p>
              ...
              designed and created to ensure those affiliated with Stylish Home
              Space of our commitment and realization of our obligation not only
            ...
            <p>
              ...
              initially collected, the user or users shall be promptly notified
              by email. Users at that time shall have the option as to whether
            ...
            <p>
              ...
              use of information by companies that Stylish Home Space does not
          ...
          <section className="section">
            ...
            <p>
              Stylish Home Space may also deem it necessary, from time to time,
              to follow websites that our users may frequent to gleam what types
              of services and products may be the most popular to customers or
              the general public.
            </p>
            <p>
          ...
          <section className="section">
            ...
            <p>
              ...
              services that may be available to you from stylishhomespace.us
            </p>
            <p>
            ...
            <p>
              ...
              including but not limited to ig.com/romko, fb.com/romko,
              x.com/romko and other interactive programs. These may collect your
              IP address and require cookies to work properly. These services
              are governed by the privacy policies of the providers and are not
              within Stylish Home Space's control.
            </p>
          </section>
          <section className="section">
            <h4>Disclosure of Information</h4>
            <p>
              Stylish Home Space may not use or disclose the information
          ...
          <section className="section">
            ...
            <p>
              Stylish Home Space greatly respects your privacy. We do maintain
          ...
          <section className="section">
            ...
            <p>
              ...
              age of thirteen (13), we shall immediately take the necessary
          ...
          <section className="section">
            ...
            <p>
              ...
              stylishhomespace@gmail.com. If you wish to unsubscribe or opt-out
              from any third-party websites, you must go to that specific
              website to unsubscribe or opt-out. Stylish Home Space will
          ...
          <section className="section">
            ...
            <p>
              ...
              Stylish Home Space does not claim nor accept responsibility for
          ...
          <section className="section">
            ...
            <p>
              Stylish Home Space's operations are located primarily in the
          ...
          <section className="section">
            ...
            <ul>
              ...
              <li>
                ...
                right to request access to the data we hold about you and we
                must respond to those requests within one month. You can do this
                by sending an email to stylishhomespace@gmail.com.
              </li>
              <li>
              ...
              <li>
                ...
                request that the information we hold be deleted, and we will
                comply unless we have a compelling reason not to, in which case
                you will be informed of same. You can do this by sending an
                email to stylishhomespace@gmail.com.
              </li>
              <li>
                <strong>The right to restrict processing: </strong>this means
                you can change your communication preferences or opt-out of
                certain communications. You can do this by sending an email to
                stylishhomespace@gmail.com.
              </li>
              <li>
                <strong>The right of data portability: </strong>this means you
                can obtain and use the data we hold for your own purposes
                without explanation. If you wish to request a copy of your
                information, contact us at stylishhomespace@gmail.com.
              </li>
              <li>
                ...
                basis is our legitimate interest in it. To do this, please send
                an email to stylishhomespace@gmail.com.
              </li>
            </ul>
            <p>
              ...
              website at stylishhomespace.us.
            </p>
          </section>
          <section className="section">
            <h4>Security</h4>
            ...
            <p>
              ...
              addition, Stylish Home Space is a licensee of TRUSTe. The website
          ...
          <section className="section">
            ...
            <ul>
              ...
              <li>
                <strong>Mailing Address: </strong>Stylish Home Space, 9225 N
                Lake Creek Pkwy 3304, Austin, Texas, 78717
              </li>
            </ul>
            <p>
           ...
           <li><strong>Controller Name</strong></li>
            <li><strong>Controller Email</strong></li>
            <li><strong>Controller Telephone</strong></li>
            <li><strong>Controller Address</strong></li>
           </ul>
          </section>
          <section className="section">
