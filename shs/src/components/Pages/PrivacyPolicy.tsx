...
const PrivacyPolicy: FC = () => {
  ...
  const faqContentPage =
    content.find((item: any) => item.AccountManagementPage) || {};
  const dbContent = faqContentPage?.AccountManagementPage?.categories || [];
    ...
    <div className="container">
      <div className="privacy_description">
        ...
        <section className="section">
          <p>
            Stylish Home Space (SHS) values its users' privacy. This Privacy
            ...
            created to ensure those affiliated with Stylish Home Space of our
          ...
          <p>
            ...
            any point in time Stylish Home Space decides to make use of any
          ...
          <p>
            This Policy applies to Stylish Home Space, and it governs any and
            all data collection and usage by us. Through the use of
            stylishhomespace.us, you are therefore consenting to the data
            collection procedures expressed in this Policy.
          </p>
          <p>
            Please note that this Policy does not govern the collection and use
            of information by companies that Stylish Home Space does not
            ...
            to better understand the way in which websites garner, make use of
        ...
        <section className="section">
          ...
          <p>
            In addition, Stylish Home Space may have the occasion to collect
          ...
          <p>
            Stylish Home Space may also deem it necessary, from time to time, to
        ...
        <section className="section">
          ...
          <p>
            Stylish Home Space does not now, nor will it in the future, sell,
            rent or lease any of its customer lists and/or names to any third
            parties.
          </p>
          <p>
            Stylish Home Space may collect and may make use of personal
            information to assist in the operation of our website and to ensure
            delivery of the services you need and request. At times, we may find
            it necessary to use personally identifiable information as a means
            to keep you informed of other possible products and/or services that
            may be available to you from stylishhomespace.us
          </p>
          <p>
            Stylish Home Space may also be in contact with you with regards to
          ...
          <p>
            Stylish Home Space may feel it necessary, from time to time, to
            contact you on behalf of our other external business partners with
            regards to a potential new offer which may be of interest to you. If
            you consent or show interest in presented offers, then, at that
            time, specific identifiable information, such as name, email address
            and/or telephone number, may be shared with the third party.
          </p>
          <p>
            Stylish Home Space may find it beneficial to all our customers to
            ...
            Those third parties shall be strictly prohibited from making use of
            your personal information, other than to deliver those services
          ...
          <p>
            Stylish Home Space uses various third-party social media features
            including but not limited to ig.com/romko, fb.com/romko, x.com/romko
            and other interactive programs. These may collect your IP address
            and require cookies to work properly. These services are governed by
            the privacy policies of the providers and are not within Stylish
            Home Space's control.
          </p>
        </section>
        <section className="section">
          <h4>Disclosure of Information</h4>
          <p>
            Stylish Home Space may not use or disclose the information provided
            by you except under the following circumstances:
          </p>
          <ul>
            <li>
            ...
            <li>
              ...
              and property of Stylish Home Space.
            </li>
          </ul>
          <p></p>
        </section>
        <section className="section">
          ...
          <p>
            Stylish Home Space greatly respects your privacy. We do maintain and
            reserve the right to contact you if needed for non-marketing
            purposes (such as bug alerts, security breaches, account issues,
            and/or changes in Stylish Home Space products and services). In
        ...
        <section className="section">
          ...
          <p>
            Stylish Home Space's website is not directed to, and does not
            ...
            or in the alternative, that verifiable parental consent is obtained
            for the use and storage of such information. Anyone under the age of
        ...
        <section className="section">
          ...
          <p>
            ...
            that you wish to unsubscribe to stylishhomespace@gmail.com. If you
            wish to unsubscribe or opt-out from any third-party websites, you
            must go to that specific website to unsubscribe or opt-out. Stylish
            Home Space will continue to adhere to this Policy with respect to
        ...
        <section className="section">
          ...
          <p>
            ...
            Stylish Home Space does not claim nor accept responsibility for any
        ...
        <section className="section">
          ...
          <p>
            Stylish Home Space's operations are located primarily in the United
        ...
        <section className="section">
          ...
          <ul>
            ...
            <li>
              <strong>The right of access:</strong>this means you have the right
              to request access to the data we hold about you and we must
              respond to those requests within one month. You can do this by
              sending an email to stylishhomespace@gmail.com.
            </li>
            <li>
            ...
            <li>
              ...
              contact us at stylishhomespace@gmail.com.
            </li>
            <li>
              ...
              email to stylishhomespace@gmail.com.
            </li>
          </ul>
          <p>
        ...
        <section className="section">
          <h4>Security</h4>
          <p>
            Stylish Home Space takes precautions to protect your information.
          ...
          <p>
            ...
            addition, Stylish Home Space is a licensee of TRUSTe. The website is
        ...
        <section className="section">
          ...
          <ul>
            ...
            <li>
              <strong>Telephone Number: </strong>+1 929 855 4625
            </li>
            <li>
              <strong>Mailing Address: </strong>Stylish Home Space, 9225 N Lake
              Creek Pkwy 3304, Austin, Texas, 78717
            </li>
          </ul>
          <p>
          ...
          <ul>
            ...
            <li>
              <strong>Controller Telephone</strong>
            </li>
            <li>
        ...
        <section className="section">
          ...
          <p>
            ...
            (i) doing an assessment of data processing activities to improve
