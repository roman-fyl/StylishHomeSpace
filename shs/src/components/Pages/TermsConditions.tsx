      ...
      <div className="terms_description">
        ...
        <section className="section">
          <p>
            ...
            legal agreement between you and Stylish Home Space (hereinafter
            "SHS"), a company duly organized and validly existing, located at
            9225 N Lake Creek Pkwy 3304, Austin, Texas 78717. This Agreement
        ...
        <section className="section">
          <h3>OVERVIEW</h3>
          <p>
            The Site (stylishhomespace.com) is operated by SHS. Throughout the
            Site, the terms "we", "us" and "our" refer to SHS. SHS offers this
            Site, including all information, tools and services available from
          ...
          <p>
            ...
            contributors of content. In the event of an inconsistency between
            this Agreement and any additional terms or policies referenced
            herein, the provisions of the additional terms or policies shall
            control.
          </p>
          <p>
        ...
        <section className="section">
          ...
          <p>
            ...
            are the age of majority in your state or province of residence and
          ...
          <p>
            ...
            laws in your jurisdiction (including but not limited to motor
            vehicle laws).
          </p>
          <p>
          ...
          <p>
            ...
            immediate termination of your account and right to use our Service.
          </p>
          <p>
          ...
          <ol>
            ...
            <li>
              Refuse, move, or remove any content that is available on all or
          ...
          <p>
            ...
            any portion of the Site, use of the Site, or access to the Site or
            any contact on the Site, without express written permission by us.
          </p>
          <p>
            ...
            SHS content is not for resale. Use of the Site does not entitle
            ...
            content without the express written permission of SHS and the
            ...
            express or implied, to the intellectual property of SHS or our
        ...
        <section className="section">
          ...
          <p>
            Once you create an account with us, you are registered on the SHS
            Site. The terms "member," "membership," and "account" all refer to
            this registration as a member on SHS's Site. If you are merely
          ...
          <p>
            ...
            password secure. You may not assign or otherwise transfer your
            account to any other person or entity. You acknowledge that SHS is
            not responsible for third party access to your account that results
            from theft or misappropriation of your account. Notify us
            immediately if you believe that someone has used your username,
          ...
          <p>
            ...
            inaccurate or incomplete nature, Stylish Home Space will have
            sufficient grounds and rights to suspend or terminate the member in
            violation of this aspect of the Agreement, and as such refuse any
            and all current or future use of Stylish Home Space Services, or any
            portion thereof.
          </p>
        </section>
        <section className="section">
          ...
          <p>
            ...
            publicly or privately posted and/or transmitted, is the expressed
            sole responsibility of the individual from whom the content
            originated. In short, this means that you are solely responsible for
            any and all content posted, uploaded, emailed, transmitted or
            otherwise made available by way of the SHS Services, and as such, we
            do not guarantee the accuracy, integrity or quality of such content.
            It is expressly understood that by use of our Services, you may be
            exposed to content including, but not limited to, any errors or
            omissions in any content posted, and/or any loss or damage of any
            kind incurred as a result of the use of any content posted, emailed,
            transmitted or otherwise made available by SHS.
          </p>
          <p>
            Furthermore, you herein agree not to make use of Stylish Home
            Space's Services for the purpose of:
          </p>
          <ol>
            <li>
            ...
            <li>
              ...
              to, any SHS officials, forum leaders, guides or hosts or falsely
            ...
            <li>
              ...
              content that you personally have no right to pursuant to any law
              nor having any contractual or fiduciary relationship with;
            </li>
            <li>
              uploading, posting, emailing, transmitting or otherwise offering
            ...
            <li>
              uploading, posting, emailing, transmitting, or otherwise offering
              any source that may contain a software virus or other computer
              code, any files and/or programs which have been designed to
              interfere, destroy and/or limit the operation of any computer
              software, hardware, or telecommunication equipment;
            </li>
            <li>
              disrupting the normal flow of communication, or otherwise acting
              in any manner that would negatively affect other users' ability to
              participate in any real time interactions;
            </li>
            <li>
              interfering with or disrupting any Stylish Home Space Services,
            ...
            <li>
              ...
              Securities and Exchange Commission, in addition to any rules of
              any nation or other securities exchange, that would include
            ...
            <li>
              ...
              "foreign terrorist organization" in accordance to Section 219 of
          ...
          <p>
            Stylish Home Space herein reserves the right to pre-screen, refuse
            and/or delete any content currently available through our Services.
            In addition, we reserve the right to remove and/or delete any such
          ...
          <p>
            Stylish Home Space herein reserves the right to access, preserve
          ...
          <ol>
            ...
            <li>
              protecting the rights, property or the personal safety of Stylish
              Home Space, its visitors, users and members, including the general
              public.
            </li>
          </ol>
          <p>
            Stylish Home Space herein reserves the right to include the use of
            security components that may permit digital information or material
            to be protected, and that such use of information and/or material is
            subject to usage guidelines and regulations established by Stylish
            Home Space or any other content providers supplying content services
            to Stylish Home Space. You are hereby prohibited from making any
            attempt to override or circumvent any of the embedded usage rules in
            our Services. Furthermore, unauthorized reproduction, publication,
        ...
        <section className="section">
          ...
          <p>
            ...
            (http://www.access.gpo.gov/bis/ear/ear_data.html), as well as the
        ...
        <section className="section">
          ...
          <p>
            Stylish Home Space shall not lay claim to ownership of any content
            ...
            hereby grant and allow for Stylish Home Space the below listed
          ...
          <ol>
            <li>
              ...
              publicly accessible areas of Stylish Home Space's Sites, the
              ...
              our network Services is for the sole purpose of providing and
              ...
              so long as you are a member of Stylish Home Space's sites, and
            ...
            <li>
              ...
              for inclusion on the publicly accessible areas of Stylish Home
              Space's sites, the license provided to permit to use, distribute,
              ...
              be available so long as you are a member of Stylish Home Space's
              sites and shall terminate at such time when you elect to
              discontinue your membership.
            </li>
            <li>
              For any other content submitted or made available for inclusion on
              the publicly accessible areas of Stylish Home Space's sites, the
          ...
          <p>
            ...
            Stylish Home Space's Sites are those such areas of our network
            ...
            available to both users and members. However, those areas which are
            not open to the public, and thus available to members only, would
            include our mail system and instant messaging.
          </p>
          <h4>CONTRIBUTIONS TO COMPANY WEBSITE</h4>
          <p>
            Stylish Home Space may provide an area for our user and members to
            contribute feedback to our website. When you submit ideas,
            documents, suggestions and/or proposals ("
            <strong>Contributions</strong>") to our site, you acknowledge and
            agree that:
          </p>
          <ol>
            <li>
            ...
            <li>
              SHS shall not be liable or under any obligation to ensure or
              maintain confidentiality, expressed or implied, related to any
              Contributions;
            </li>
            <li>
              SHS shall be entitled to make use of and/or disclose any such
              Contributions in any such manner as they may see fit;
            </li>
            <li>
              the contributor's Contributions shall automatically become the
              sole property of SHS; and
            </li>
            <li>
              SHS is under no obligation to either compensate or provide any
        ...
        <section className="section">
          ...
          <p>
            All users and/or members agree to insure and hold Stylish Home
            Space, our subsidiaries, affiliates, agents, employees, officers,
            ...
            of SHS Services or your connection with these Services, your
        ...
        <section className="section">
          ...
          <p>
            ...
            use of, or access to SHS's sites.
          </p>
        </section>
        <section className="section">
          <h3>SECTION 8 - MODIFICATIONS</h3>
          <p>
            Stylish Home Space reserves the right at any time it may deem fit,
            to modify, alter and or discontinue, whether temporarily or
        ...
        <section className="section">
          ...
          <p>
            As a member of stylishhomespace.com, you may cancel or terminate
          ...
          <p>
            As a member, you agree that Stylish Home Space may, without any
          ...
          <ol>
            ...
            <li>
              ...
              connection with your stylishhomespace.com account Services.
            </li>
          </ol>
          <p>
        ...
        <section className="section">
          ...
          <p>
            Either Stylish Home Space or any third parties may provide links to
            ...
            external sites or resources, and as such, we do not endorse nor are
            we responsible or liable for any content, products, advertising or
            any other materials, on or available from such third-party sites or
            resources. Furthermore, you acknowledge and agree that Stylish Home
            Space shall not be responsible or liable, directly or indirectly,
            for any such damage or loss which may be a result of, caused or
            allegedly to be caused by or in connection with the use of or the
            reliance on any such content, goods or Services made available on or
        ...
        <section className="section">
          ...
          <p>
            You do hereby acknowledge and agree that Stylish Home Space's
            Services and any essential software that may be used in connection
            with our Services ("Software") shall contain proprietary and
            confidential material that is protected by applicable intellectual
            property rights and other laws. Furthermore, you herein acknowledge
            and agree that any Content which may be contained in any
            advertisements or information presented by and through our Services
            or by advertisers is protected by copyrights, trademarks, patents or
            other proprietary rights and laws. Therefore, except for that which
            is expressly permitted by applicable law or as authorized by Stylish
            Home Space or such applicable licensor, you agree not to alter,
            modify, lease, rent, loan, sell, distribute, transmit, broadcast,
            publicly perform and/or created any plagiaristic works which are
            based on Stylish Home Space Services (e.g. Content or Software), in
            whole or part.
          </p>
          <p>
            Stylish Home Space hereby grants you a personal, non-transferable
            and non-exclusive right and/or license to make use of the object
            code or our Software on a single computer, as long as you do not,
            and shall not, allow any third party to duplicate, alter, modify,
            ...
            otherwise transfer any such right in the Software. Furthermore, you
            do herein agree not to alter or change the Software in any manner,
            nature or form, and as such, not to use any modified versions of the
            Software, including and without limitation, for the purpose of
            obtaining unauthorized access to our Services. Lastly, you also
            agree not to access or attempt to access our Services through any
            means other than through the interface which is provided by Stylish
            Home Space for use in accessing our Services.
          </p>
        </section>
        <section className="section">
          ...
          <ol>
            <li>
              THE USE OF STYLISH HOME SPACE SERVICES AND SOFTWARE ARE AT THE
              SOLE RISK BY YOU. OUR SERVICES AND SOFTWARE SHALL BE PROVIDED ON
              AN "AS IS" AND/OR "AS AVAILABLE" BASIS. STYLISH HOME SPACE AND OUR
              SUBSIDIARIES, AFFILIATES, OFFICERS, EMPLOYEES, AGENTS, PARTNERS
              AND LICENSORS EXPRESSLY DISCLAIM ANY AND ALL WARRANTIES OF ANY
              KIND WHETHER EXPRESSED OR IMPLIED, INCLUDING, BUT NOT LIMITED TO
              ANY IMPLIED WARRANTIES OF TITLE, MERCHANTABILITY, FITNESS FOR A
              PARTICULAR PURPOSE AND NON-INFRINGEMENT.
            </li>
            <li>
              STYLISH HOME SPACE AND OUR SUBSIDIARIES, OFFICERS, EMPLOYEES,
              AGENTS, PARTNERS AND LICENSORS MAKE NO SUCH WARRANTIES THAT (i)
              STYLISH HOME SPACE SERVICES OR SOFTWARE WILL MEET YOUR
              REQUIREMENTS; (ii) STYLISH HOME SPACE SERVICES OR SOFTWARE SHALL
              BE UNINTERRUPTED, TIMELY, SECURE OR ERROR-FREE; (iii) THAT SUCH
              RESULTS WHICH MAY BE OBTAINED FROM THE USE OF THE STYLISH HOME
              SPACE SERVICES OR SOFTWARE WILL BE ACCURATE OR RELIABLE; (iv)
            ...
            <li>
              ...
              WAY OF STYLISH HOME SPACE SERVICES OR SOFTWARE SHALL BE ACCESSED
            ...
            <li>
              ...
              THAT MAY BE OBTAINED BY YOU FROM STYLISH HOME SPACE OR BY WAY OF
        ...
        <section className="section">
          ...
          <p>
            YOU EXPLICITLY ACKNOWLEDGE, UNDERSTAND AND AGREE THAT STYLISH HOME
            SPACE AND OUR SUBSIDIARIES, AFFILIATES, OFFICERS, EMPLOYEES, AGENTS,
        ...
        <section className="section">
          ...
          <p>
            In the event you have a dispute, you agree to release Stylish Home
            Space (and its officers, directors, employees, agents, parent
        ...
        <section className="section">
          ...
          <p>
            Stylish Home Space may furnish you with notices, including those
            with regards to any changes to the Terms, including but not limited
            to email, regular mail, MMS or SMS, text messaging, postings on our
        ...
        <section className="section">
          ...
          <p>
            You herein acknowledge, understand and agree that all of the Stylish
            Home Space trademarks, copyright, trade name, service marks, and
            other Stylish Home Space logos and any brand features, and/or
            product and service names are trademarks and as such, are and shall
            remain the property of Stylish Home Space. You herein agree not to
            display and/or use in any manner the Stylish Home Space logo or
            marks without obtaining Stylish Home Space's prior written consent.
          </p>
          <p>
            Stylish Home Space will always respect the intellectual property of
            others, and we ask that all of our users do the same. With regards
            to appropriate circumstances and at its sole discretion, Stylish
            Home Space may disable and/or terminate the accounts of any user who
            violates our Terms and/or infringes the rights of others. If you
            feel that your work has been duplicated in such a way that would
          ...
          <ol>
            ...
            <li>
              ...
              aforementioned information in your notice is truthful and
          ...
          <p>
            The Stylish Home Space agent for notice of claims of copyright or
            other intellectual property infringement can be contacted as
            follows:
          </p>
          <p>
            <strong>Mailing Address: </strong>Stylish Home Space, Attn:
            Copyright Agent, 9225 N Lake Creek Pkwy 3304, Austin, Texas 78717
          </p>
          <p>
            <strong>Telephone: </strong>929 855 4625
          </p>
          <p>
            <strong>Email: </strong> stylishhomespace@gmail.com
          </p>
        </section>
        <section className="section">
          ...
          <p>
            ...
            Stylish Home Space and shall govern the use of our Services,
            superseding any prior version of this Agreement between you and us
            with respect to Stylish Home Space Services. You may also be subject
            to additional terms and conditions that may apply when you use or
            purchase certain other Stylish Home Space Services, affiliate
        ...
        <section className="section">
          ...
          <p>
            It is at the mutual agreement of both you and Stylish Home Space
            with regard to the Agreement that the relationship between the
            parties shall be governed by the laws of the state of Texas without
            ...
            to the Agreement, or the relationship between you and Stylish Home
            Space, shall be filed within the courts having jurisdiction within
            the County of Travis, Texas or the U.S. District Court located in
            said state. You and Stylish Home Space agree to submit to the
            jurisdiction of the courts as previously mentioned, and agree to
        ...
        <section className="section">
          ...
          <p>
            At any time, should Stylish Home Space fail to exercise or enforce
            any right or provision of the Agreement, such failure shall not
        ...
        <section className="section">
          ...
          <p>
            ...
            related to the use of our Services or the Agreement must be filed
            within 4 year(s) after said claim or cause of action arose or shall
            be forever barred.
          </p>
        </section>
        <section className="section">
          ...
          <p>
            Please report any and all violations of this Agreement to Stylish
        ...
        <section className="section">
          ...
          <p>
            ...
            operation of our business and systems, we may access and disclose
            any information we consider necessary or appropriate, including and
            without limitation, your information, IP address, and usage history.
            Our right to disclose any such information is governed by the terms
        ...
        <section className="section">
          ...
          <p>
            The Site is controlled, operated and administered by SHS from our
            offices within the USA. If you access the Site from a location
            outside the USA, you are responsible for compliance with all local
            laws. You agree that you will not use SHS's content accessed through
            the Site in any country or in any manner prohibited by any
        ...
        <section className="section">
          ...
          <p>
            ...
            update information or cancel orders if any information on the Site
            or on any related Site is inaccurate at any time without prior
          ...
          <p>
            ...
            or refresh date applied on the Site or on any related Site, should
            be taken to indicate that all information on the Site or on any
            related Site has been modified or updated.
          </p>
        </section>
        <section className="section">
          ...
          <p>
            ...
            information are strictly protected by the Stylish Home Space Online
            Privacy Policy (see the full Privacy Policy at privacy.html). As a
            ...
            use by Stylish Home Space and/or our subsidiaries and affiliates.
          </p>
        </section>
      </div>
    </div>
